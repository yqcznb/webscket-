var Local = function(socket) {
    ...
    var bindKeyEvent = function(){
        ...
        document.getElementById('local_down').onclick = function() {
            game.fall();
            socket.emit('fall');
        }
        document.getElementById('local_left').onclick = function() {
            game.left();
            socket.emit('left');
        }
        document.getElementById('local_right').onclick = function() {
            game.right();
            socket.emit('right');
        }
        document.getElementById('local_rotate').onclick = function() {
            game.rotate();
            socket.emit('rotate');
        }
    }
